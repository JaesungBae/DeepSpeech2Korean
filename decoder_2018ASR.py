...
class Decoder(object):
    ...
    def __init__(self, labels, blank_index=0):
        ...
        # for example: {0: '_', 1: "'", 2: 'A', 3: 'B', 4: 'C', 5: 'D', 6: 'E', 7: 'F', 8: 'G', 9: 'H', 10: 'I', 11: 'J', 12: 'K', 13: 'L', 14: 'M', 15: 'N', 16: 'O', 17: 'P', 18: 'Q', 19: 'R', 20: 'S', 21: 'T', 22: 'U', 23: 'V', 24: 'W', 25: 'X', 26: 'Y', 27: 'Z', 28: ' '}
...
class GreedyDecoder(Decoder):
    ...
    def process_string(self, sequence, size, remove_repetitions=False):
        ...
        offsets = []
        for i in range(size):
            char = self.int_to_char[int(sequence[i].cpu())]
            if char != self.int_to_char[self.blank_index]:
                # if this char is a repetition and remove_repetitions=true, then skip
                if remove_repetitions and i != 0 and char == self.int_to_char[int(sequence[i - 1].cpu())]:
                    pass
